...
public class MainMultidimensional {
    ...
    public static void main(String[] args) {
        /*
        // Forma de declarar una array bidimensional -> int[][] matriz = new int[3][3];
        ...
        // 13  4  7
        // matriz[2] -> [0,0,0]
        // matriz[2][1] -> 4 Accedemos a la segunda fila y primera columna de la matriz
        // cuantas filas tengo
        System.out.println("El tamaño de las filas es de "+matriz.length); // 3 ->Longitud de la matriz
        ...
        //matriz[2][0] -> Accedemos al valor en la posicion [2][0] de la matriz
        //System.out.println("El elemento buscado es "+matriz[2][0]);

        // matriz[2][0] = 6; ->Modificamos el valor


        // sacar todos los elementos -> for anidado
        // System.out.println(Arrays.toString(matriz));
        for (int i = 0; i < matriz.length; i++) {
            for (int j = 0; j < matriz[i].length; j++) { //Recorremos la matriz hasta la fila correspondiente
                if(matriz[i][j]%2==0){
